import { buildContentRegistry } from "./data/contentRegistry.js?v=0.7.1";
import { buildClubHandPatch, getClubSnapshotForTable, normalizeClubNpcState } from "./engine/club.js?v=0.7.1";
import { createNewCareer, createNewPlayer, applyHandResult, addPlayerRewards, applyChallenges, ensureActiveChallenges, normalizeCareer, normalizePlayer, updateCareerUnlocks } from "./engine/career.js?v=0.7.1";
import { applyUnlocks } from "./engine/collections.js?v=0.7.1";
import {
  ...
  applyPlayerAction,
} from "./engine/poker.js?v=0.7.1";
import { clearSave, exportCurrentSave, getSaveInfo, importSaveText, loadSave, saveGame } from "./engine/save.js?v=0.7.1";
import { getClubContext } from "./engine/world.js?v=0.7.1";
import { APP_VERSION, BUILD_ID } from "./config/appMeta.js?v=0.7.1";
import { applyPendingUpdate, checkForRemoteVersion, forceAppUpdate, getRuntimeStatus, onUpdateReady, registerAppServiceWorker } from "./engine/update.js?v=0.7.1";
import { renderScreen, SCREENS } from "./ui/screens.js?v=0.7.1";
import { escapeHtml } from "./ui/components.js?v=0.7.1";
...
export class PokerRoomStoryApp {
  ...
  sanitizeLoadedTableState(tableState, saveMeta = null) {
    ...
    const cameFromUnsafeTimeline = activeHand && isVersionBefore(saveVersion, "0.7.1");
