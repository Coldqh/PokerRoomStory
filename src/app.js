import { buildContentRegistry } from "./data/contentRegistry.js?v=0.4.5";
import { createNewCareer, createNewPlayer, applyHandResult, updateCareerUnlocks } from "./engine/career.js?v=0.4.5";
import { applyUnlocks } from "./engine/collections.js?v=0.4.5";
import {
  ...
  applyPlayerAction,
} from "./engine/poker.js?v=0.4.5";
import { clearSave, exportCurrentSave, getSaveInfo, importSaveText, loadSave, saveGame } from "./engine/save.js?v=0.4.5";
import { getClubContext } from "./engine/world.js?v=0.4.5";
import { APP_VERSION, BUILD_ID } from "./config/appMeta.js?v=0.4.5";
import { applyPendingUpdate, checkForRemoteVersion, forceAppUpdate, getRuntimeStatus, onUpdateReady, registerAppServiceWorker } from "./engine/update.js?v=0.4.5";
import { renderScreen, SCREENS } from "./ui/screens.js?v=0.4.5";
import { escapeHtml } from "./ui/components.js?v=0.4.5";
...
export class PokerRoomStoryApp {
  ...
  sanitizeLoadedTableState(tableState, saveMeta = null) {
    ...
    const cameFromUnsafeTimeline = activeHand && isVersionBefore(saveVersion, "0.4.5");
