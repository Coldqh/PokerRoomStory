import { FALLBACK_START_LOCATION } from "./selectors.js?v=2.4.0";
import { normalizeClubProgress } from "./progression.js?v=2.4.0";
import { createInitialLifeState, normalizeLifeState } from "./life.js?v=2.4.0";
