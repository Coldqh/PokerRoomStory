import { FALLBACK_START_LOCATION } from "./selectors.js?v=3.7.1";
import { normalizeClubProgress } from "./progression.js?v=3.7.1";
import { createInitialLifeState, normalizeLifeState } from "./life.js?v=3.7.1";
import { createInitialBusinessState, normalizeBusinessState } from "./businesses.js?v=3.7.1";
import { createInitialJobsState, normalizeJobsState } from "./jobs.js?v=3.7.1";
import { createInitialCityGoalsState, normalizeCityGoalsState } from "./cityGoals.js?v=3.7.1";
