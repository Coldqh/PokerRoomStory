import { FALLBACK_START_LOCATION } from "./selectors.js?v=3.6.0";
import { normalizeClubProgress } from "./progression.js?v=3.6.0";
import { createInitialLifeState, normalizeLifeState } from "./life.js?v=3.6.0";
import { createInitialBusinessState, normalizeBusinessState } from "./businesses.js?v=3.6.0";
import { createInitialJobsState, normalizeJobsState } from "./jobs.js?v=3.6.0";
import { createInitialCityGoalsState, normalizeCityGoalsState } from "./cityGoals.js?v=3.6.0";
