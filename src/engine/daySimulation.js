import { getLifeHousing, getLifeVehicle } from "./lifeContent.js?v=3.5.0";
import { getBusinessDailyProfit, normalizeBusinessState } from "./businesses.js?v=3.5.0";
import { getBusinessTemplate } from "./businessContent.js?v=3.5.0";
import { getJobById } from "./jobContent.js?v=3.5.0";
