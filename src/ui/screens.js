import { canEnterTable, getClubContext } from "../engine/world.js?v=0.6.1";
import { getClubMoodLabel, getClubRepInfo, getClubRoomState, getNpcMoodProfile } from "../engine/club.js?v=0.6.1";
import { getPhaseLabel, getAvailableActions, getActionMeta, getHandHint, getCurrentHandInfo } from "../engine/poker.js?v=0.6.1";
import { getActiveChallenges, getChallengeDifficultyLabel, getChallengeProgress, getCompletedChallenges, getRankInfo, getRankLabel, getRankProgress, getXpProgress } from "../engine/career.js?v=0.6.1";
import { describeCards } from "../engine/cards.js?v=0.6.1";
import { badges, emptyState, escapeHtml, metric, playingCards, progressBar } from "./components.js?v=0.6.1";
...
function renderSystemPanel(state) {
  ...
  return `
    <section class="content-section system-panel">
      <div class="section-title"><h3>Система</h3><span>v${escapeHtml(system.appVersion ?? "0.6.1")}</span></div>
