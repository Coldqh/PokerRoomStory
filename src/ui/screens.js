import { canEnterTable, getClubContext } from "../engine/world.js?v=0.9.4";
import { getClubRoomState } from "../engine/club.js?v=0.9.4";
import { getPhaseLabel, getAvailableActions, getActionMeta, getHandHint, getCurrentHandInfo } from "../engine/poker.js?v=0.9.4";
import { getActiveChallenges, getChallengeDifficultyLabel, getChallengeProgress, getCompletedChallenges, getRankInfo, getRankLabel, getRankProgress, getXpProgress } from "../engine/career.js?v=0.9.4";
import { describeCards } from "../engine/cards.js?v=0.9.4";
import { badges, emptyState, escapeHtml, metric, playingCards, progressBar } from "./components.js?v=0.9.4";
  ...
  return `
    ...
    <section class="settings-grid">
      ...
      <article class="panel-soft settings-card settings-wide">
        <div class="section-title"><h3>Система</h3><span>v${escapeHtml(system.appVersion ?? "0.9.4")}</span></div>
