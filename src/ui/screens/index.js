import { renderLifeScreen } from "./lifeScreen.js?v=2.9.0";
import { renderLocationScreen } from "./locationScreen.js?v=2.9.0";
...
import { renderCareerScreen } from "./careerScreen.js?v=2.9.0";
import { renderTasksScreen } from "./tasksScreen.js?v=2.9.0";
import { renderNpcScreen } from "./npcScreen.js?v=2.9.0";
import { renderGlossaryScreen } from "./glossaryScreen.js?v=2.9.0";
import { renderCollectionsScreen } from "./collectionsScreen.js?v=2.9.0";
import { renderSettingsScreen } from "./settingsScreen.js?v=2.9.0";
import { renderBuyInModal, renderBetAmountModal } from "./modals.js?v=2.9.0";
