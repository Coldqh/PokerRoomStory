import { renderLifeScreen } from "./lifeScreen.js?v=3.4.1";
import { renderLocationScreen } from "./locationScreen.js?v=3.4.1";
...
import { renderCareerScreen } from "./careerScreen.js?v=3.4.1";
import { renderTasksScreen } from "./tasksScreen.js?v=3.4.1";
import { renderNpcScreen } from "./npcScreen.js?v=3.4.1";
import { renderGlossaryScreen } from "./glossaryScreen.js?v=3.4.1";
import { renderCollectionsScreen } from "./collectionsScreen.js?v=3.4.1";
import { renderSettingsScreen } from "./settingsScreen.js?v=3.4.1";
import { renderBuyInModal, renderBetAmountModal } from "./modals.js?v=3.4.1";
