import { escapeHtml } from "../components.js?v=1.0.1";
import { formatDateTime, speedLabel } from "./common.js?v=1.0.1";
  ...
  return `
    ...
    <section class="settings-grid">
      ...
      <article class="panel-soft settings-card settings-wide">
        <div class="section-title"><h3>Система</h3><span>v${escapeHtml(system.appVersion ?? "1.0.1")}</span></div>
