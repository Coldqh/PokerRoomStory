import { escapeHtml } from "../components.js?v=0.9.8";
import { formatDateTime, speedLabel } from "./common.js?v=0.9.8";
  ...
  return `
    ...
    <section class="settings-grid">
      ...
      <article class="panel-soft settings-card settings-wide">
        <div class="section-title"><h3>Система</h3><span>v${escapeHtml(system.appVersion ?? "0.9.8")}</span></div>
