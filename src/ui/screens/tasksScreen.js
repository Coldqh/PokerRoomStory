import { getActiveChallenges, getChallengeDifficultyLabel, getChallengeProgress, getCompletedChallenges } from "../../engine/career.js?v=3.1.0";
import { getCityGoalRoadmap } from "../../engine/cityGoals.js?v=3.1.0";
import { emptyState, escapeHtml, progressBar } from "../components.js?v=3.1.0";
