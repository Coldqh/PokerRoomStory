...
const APP_SHELL = [
  ...
  "./index.html",
  "./version.json",
  "./manifest.webmanifest?v=0.4.6",
  "./src/main.js?v=0.4.6",
  "./src/app.js?v=0.4.6",
  "./src/styles.css?v=0.4.6",
  "./src/config/appMeta.js?v=0.4.6",
  "./src/data/contentRegistry.js?v=0.4.6",
  "./src/data/packs/coreV01.js?v=0.4.6",
  "./src/engine/cards.js?v=0.4.6",
  "./src/engine/career.js?v=0.4.6",
  "./src/engine/collections.js?v=0.4.6",
  "./src/engine/npc.js?v=0.4.6",
  "./src/engine/poker.js?v=0.4.6",
  "./src/engine/save.js?v=0.4.6",
  "./src/engine/update.js?v=0.4.6",
  "./src/engine/world.js?v=0.4.6",
  "./src/ui/components.js?v=0.4.6",
  "./src/ui/screens.js?v=0.4.6",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
