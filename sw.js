...
const APP_SHELL = [
  ...
  "./src/main.js?v=0.6.1",
  "./src/app.js?v=0.6.1",
  "./src/styles.css?v=0.6.1",
  "./src/config/appMeta.js?v=0.6.1",
  "./src/data/contentRegistry.js?v=0.6.1",
  "./src/data/namePools.js?v=0.6.1",
  "./src/data/packs/coreV01.js?v=0.6.1",
  "./src/engine/cards.js?v=0.6.1",
  "./src/engine/career.js?v=0.6.1",
  "./src/engine/club.js?v=0.6.1",
  "./src/engine/collections.js?v=0.6.1",
  "./src/engine/npc.js?v=0.6.1",
  "./src/engine/poker.js?v=0.6.1",
  "./src/engine/save.js?v=0.6.1",
  "./src/engine/update.js?v=0.6.1",
  "./src/engine/world.js?v=0.6.1",
  "./src/ui/components.js?v=0.6.1",
  "./src/ui/screens.js?v=0.6.1",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
