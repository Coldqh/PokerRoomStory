...
const APP_SHELL = [
  ...
  "./src/main.js?v=0.9.3",
  "./src/app.js?v=0.9.3",
  "./src/styles.css?v=0.9.3",
  "./src/config/appMeta.js?v=0.9.3",
  "./src/data/contentRegistry.js?v=0.9.3",
  "./src/data/namePools.js?v=0.9.3",
  "./src/data/packs/coreV01.js?v=0.9.3",
  "./src/engine/cards.js?v=0.9.3",
  "./src/engine/career.js?v=0.9.3",
  "./src/engine/club.js?v=0.9.3",
  "./src/engine/collections.js?v=0.9.3",
  "./src/engine/npc.js?v=0.9.3",
  "./src/engine/poker.js?v=0.9.3",
  "./src/engine/save.js?v=0.9.3",
  "./src/engine/update.js?v=0.9.3",
  "./src/engine/world.js?v=0.9.3",
  "./src/ui/components.js?v=0.9.3",
  "./src/ui/screens.js?v=0.9.3",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
